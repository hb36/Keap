...
public class Move_DatabaseHelper extends SQLiteOpenHelper// 继承SQLiteOpenHelper类
{
    ...
    public Move_DatabaseHelper(Context context, String name, CursorFactory factory,
    ...
    public Move_DatabaseHelper(Context context)
    {
